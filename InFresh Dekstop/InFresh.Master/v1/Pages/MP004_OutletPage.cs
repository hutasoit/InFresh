...
{
    public partial class MP004_OutletPage : DockContent, IDock
    {
        #region Constructor & Properties
        public MP004_OutletPage()
        {
            InitializeComponent();
        ...
        {
            MasterModule.Handler.Host.ReverseToolbar(tlsOToolbar);
            MasterModule.Handler.Host.ReverseStatusbar(stsOStatusbar);
        }
        ...
        private void Form_Activated(object sender, EventArgs e)
        {
            ...
            {
                MasterModule.Handler.Host.MergeToolbar(tlsOToolbar);
                MasterModule.Handler.Host.MergeStatusbar(stsOStatusbar);
                Controls.Remove(stsOStatusbar);
            }
        }
        ...
        private void Form_DockStateChanged(object sender, EventArgs e)
        {
            if (DockState == DockState.Float)
            {
                ...
                Controls.Remove(tlsOToolbar);
                Controls.Remove(stsOStatusbar);

                Controls.Add(tlsOToolbar);
                Controls.Add(stsOStatusbar);
        ...
        private void ToolbarItem_Click(object sender, EventArgs e)
        {
            ...
            if (sender == tsbNew || sender == tsbEdit)
            {
                tsbList.Enabled = tsbNew.Enabled = tsbEdit.Enabled =
                    ...
                    txtCity.ReadOnly = txtZipCode.ReadOnly =
                ...
                if (sender == tsbNew)
                {
                    ...
                    txtCode.Text = txtCode.Text = txtName.Text =
                    txtAddr1.Text = txtAddr2.Text = txtCity.Text =
                    txtZipCode.Text = txtPhone1.Text =
                      ...
                      sender == tsbDelete || sender == tsbTruncate)
            {
                ...
                tsbList.Enabled = tsbNew.Enabled = tsbTruncate.Visible =
                    ...
                    tslRecord.Visible = txtCode.ReadOnly = txtName.ReadOnly =
                    txtAddr1.ReadOnly = txtAddr2.ReadOnly = txtCity.ReadOnly =
                    txtZipCode.ReadOnly = txtPhone1.ReadOnly =
                ...
                try
                {
                    ...
                    switch (idx)
                    {
                        ...
                        case Flag.DataLoading:
                            if (Data != null)
                                Data.Clear();
                            Data = MasterModule.Handler.RepositoryV2.Get<OutletDto>()
        ...
        private void ShowDetail()
        {
            ...
            if (mm != null)
            {
                txtMasterCode.Text = mm.Code;
                //txtCode.Text = mm.OldCode;
